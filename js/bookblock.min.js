(function(c) {
    var a = c.document,
    d = c.Modernizr;
    d.addTest("csstransformspreserve3d",
    function() {
    ...
    b.prototype = {
        ...
        _initEvents: function() {
            ...
            if (this.options.nextEl !== "") {
                a.querySelector(this.options.nextEl).addEventListener("click",
                function() {
                    f._action("next");
                    return false
                });
                a.querySelector(this.options.nextEl).addEventListener("touchstart",
                function() {
                    f._action("next");
                    return false
                })
            ...
            if (this.options.prevEl !== "") {
                a.querySelector(this.options.prevEl).addEventListener("click",
                function() {
                    f._action("prev");
                    return false
                });
                a.querySelector(this.options.prevEl).addEventListener("touchstart",
                function() {
                    f._action("prev");
                    return false
                })
        ...
        _layout: function(i) {
            ...
            p.addEventListener(this.transEndEventName,
            function(r) {
